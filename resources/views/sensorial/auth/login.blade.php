    ...
    <div class="container">
            ...
            <div class="box">
                <div class="content">
                    ...
                    <div class="a position-relative">
                        ...
                        <a href="" class="input-1 form-control">
                            <img src="{{ asset('requirement/icon/facebook-svgrepo-com.svg') }}" alt=""
                                class="img-1">
                            Login with Facebook
                        </a>
      ...
      @endif --}}
                    <form action="{{ route('login') }}" method="post" class="form-1">
                        ...
                        <a href="{{ route('instructor_login') }}" class="btn btn-primary">Login As Instructor</a>
                        <a href="{{ route('admin_login') }}" class="btn btn-primary">Login As Admin </a>
                        <div class="sign">
