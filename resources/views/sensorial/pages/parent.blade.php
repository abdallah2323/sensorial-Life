...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('requirement/pages/css/rtl.css') }}">
    <link rel="stylesheet" href="{{ asset('requirement/pages/css/ltr.css') }}">
    <link id="pagestyle" rel="stylesheet" type="text/css" href="defult">
...
<body id="page-top" onload="translate('en','lng-tag')">
    @auth
        <header>
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    <a class="navbar-brand" href="#"><img src="{{ asset('requirement/pages/img/logo.png') }}"
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 align-items-center">
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="#" lng-tag="Home">Home</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#" lng-tag="About us">About us</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#" lng-tag="Training program">Training program</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#" lng-tag="Courses">Courses</a>
                            </li>
                            ...
                            <div class="icons">
                                ...
                                <button value="en" id="enTranslator" onclick="swapStyleSheet('dir/ltr.css')"
                                    lmg-tag="flag"><img src="{{ asset('requirement/pages/img/usa.jpeg') }}" alt=""
                                        class="jordan"></button>
                                <button value="ar" id="arTranslator" onclick="swapStyleSheet('dir/rtl.css')"><img
                                        src="{{ asset('requirement/pages/img/jordan.jpeg') }}" alt=""
                                        class="jordan"></button>
                                ...
                                <div class="heart-1 position-relative">
                                    ...
                                    <div class="box-1 box-private">
                                        <img src="img/wishlist.png" alt="" class="img-fluid img-3 img-4">
                                        <div class="content-1">
                                ...
                                <div class="bell-1 position-relative">
                                    ...
                                    <div class="box-4">
                                        ...
                                        <div class="person">
                                            <img src="img/person.png" alt="" class="img-fluid man">
                                            ...
                                            <a href="{{ route('viewCart') }}">
                                                <svg class="baskets" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <g id="Mask_Group_2" data-name="Mask Group 2"
                                                        ...
                                                        <g id="Xnix_Line_shopping-bag_3"
                                                            data-name="Xnix/Line/shopping-bag_3"
                                                ...
                                                @foreach ($cart as $course)
                                                    <div>
                                                        ...
                                                        <div class="content-1">
                                                            ...
                                                            <p class="pp-2" style="color: #9f007e">
                                                                ${{ $course->price }}
                                                            </p>
                                                        </div>
                                                    </div>
                                ...
                                <span class="profile-1 position-relative">
                                    ...
                                    <div class="logout">
                                        <ul class="list-unstyled log">
                                            <li lng-tag="View Profile"><i class="fa-regular fa-address-card"></i>View
                                                Profile</li>
                                            <li lng-tag="Log-out"> <a href="{{ route('logout') }}">
    ...
    <script defer src="{{ asset('requirement/pages/js/translate.js') }}"></script>
    <script defer src="{{ asset('requirement/pages/js/index.js') }}"></script>
    @yield('scripts')
