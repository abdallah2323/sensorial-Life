                            ...
                            <tr>
                                ...
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="profile.html" class="avatar"> <img width="100%" height="100%"
                                                src="{{ asset('requirement/uploads/photo/' . $admin->photo) }}"></a>
                                        <a href="profile.html" style="text-transform: capitalize;font-weight: 600"
                                            class="name_en"> {{ $admin->name_en }}</a>
                                    </h2>
                                </td>
