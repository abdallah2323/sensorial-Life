            ...
            <ul class="nav user-menu">
                ...
                <li class="nav-item dropdown has-arrow flag-nav">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button">
                        <img src="{{ asset('requirement/assets/img/flags/us.png') }}" alt="" height="20">
                        <span>English</span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="{{ asset('requirement/assets/img/flags/us.png') }}" alt=""
                                height="16">
                            English
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="{{ asset('requirement/assets/img/flags/fr.png') }}" alt=""
                                height="16"> French
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="{{ asset('requirement/assets/img/flags/es.png') }}" alt=""
                                height="16"> Spanish
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="{{ asset('requirement/assets/img/flags/de.png') }}" alt=""
                                height="16"> German
                        </a>
                    </div>
                </li>
                                ...
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media">
                                            <span class="avatar">
                                                <img alt=""
                                                    src="{{ asset('requirement/assets/img/profiles/avatar-02.jpg') }}">
                                            </span>
                                ...
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media">
                                            <span class="avatar">
                                                <img alt=""
                                                    src="{{ asset('requirement/assets/img/profiles/avatar-03.jpg') }}">
                                            </span>
                                            <div class="media-body">
                                ...
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media">
                                            <span class="avatar">
                                                <img alt=""
                                                    src="{{ asset('requirement/assets/img/profiles/avatar-06.jpg') }}">
                                            </span>
                                            <div class="media-body">
                                ...
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media">
                                            <span class="avatar">
                                                <img alt=""
                                                    src="{{ asset('requirement/assets/img/profiles/avatar-17.jpg') }}">
                                            </span>
                                            <div class="media-body">
                                ...
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media">
                                            <span class="avatar">
                                                <img alt=""
                                                    src="{{ asset('requirement/assets/img/profiles/avatar-13.jpg') }}">
                                            </span>
                                            <div class="media-body">
